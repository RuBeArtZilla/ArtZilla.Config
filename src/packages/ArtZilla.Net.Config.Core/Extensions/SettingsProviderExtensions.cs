...
public static class SettingsProviderExtensions {
	...
	/// <inheritdoc cref="ISyncSettingsProvider.IsExist"/>
	public static bool IsExist<TSettings>(this ISyncSettingsProvider provider, string key)
	...
	/// <inheritdoc cref="ISyncSettingsProvider.Flush"/>
	public static void Flush<TSettings>(this ISyncSettingsProvider provider, string key)
		where TSettings : class, ISettings
	...
	/// <inheritdoc cref="ISyncSettingsProvider.Delete"/>
	public static bool Delete<TSettings>(this ISyncSettingsProvider provider, string key)
		where TSettings : class, ISettings
	...
	public static TSettings Get<TSettings>(this ISyncSettingsProvider provider, SettingsKind kind)
		where TSettings : class, ISettings
		=> (TSettings)provider.Get(typeof(TSettings), kind);

	/// <inheritdoc cref="ISyncSettingsProvider.Get"/>
	public static TSettings Get<TSettings>(this ISyncSettingsProvider provider, SettingsKind kind, string key)
		where TSettings : class, ISettings
	...
	/// Get settings (copy)
	public static TSettings Copy<TSettings>(this ISyncSettingsProvider provider, string key)
		where TSettings : class, ISettings
	...
	/// Get settings (read)
	public static TSettings Read<TSettings>(this ISyncSettingsProvider provider, string key)
		where TSettings : class, ISettings
	...
	/// Get settings (inpc)
	public static TSettings Inpc<TSettings>(this ISyncSettingsProvider provider, string key)
		where TSettings : class, ISettings
	...
	/// Get settings (real)
	public static TSettings Real<TSettings>(this ISyncSettingsProvider provider, string key)
		where TSettings : class, ISettings
		=> (TSettings)provider.Get(typeof(TSettings), SettingsKind.Real, key);

	/// Get settings (real)
	public static TSettings Real<TSettings>(this ISyncSettingsProvider provider, PropertyChangedEventHandler handler)
		where TSettings : class, ISettings {
		var settings = provider.Get(typeof(TSettings), SettingsKind.Real);
		((IRealSettings)settings).PropertyChanged += handler;
		return (TSettings)settings;
	}

	/// <inheritdoc cref="IAsyncSettingsProvider.IsExistAsync"/>
	public static Task<bool> IsExistAsync<TSettings>(this IAsyncSettingsProvider provider)
		where TSettings : class, ISettings
		=> provider.IsExistAsync(typeof(TSettings));

	/// <inheritdoc cref="IAsyncSettingsProvider.IsExistAsync"/>
	public static Task<bool> IsExistAsync<TSettings>(this IAsyncSettingsProvider provider, string key)
		where TSettings : class, ISettings
	...
	/// <inheritdoc cref="IAsyncSettingsProvider.FlushAsync"/>
	public static Task FlushAsync<TSettings>(this IAsyncSettingsProvider provider, string key)
		where TSettings : class, ISettings
		=> provider.FlushAsync(typeof(TSettings), key);

	/// <inheritdoc cref="IAsyncSettingsProvider.DeleteAsync"/>
	public static Task<bool> DeleteAsync<TSettings>(this IAsyncSettingsProvider provider)
		where TSettings : class, ISettings
		=> provider.DeleteAsync(typeof(TSettings));

	/// <inheritdoc cref="IAsyncSettingsProvider.DeleteAsync"/>
	public static Task<bool> DeleteAsync<TSettings>(this IAsyncSettingsProvider provider, string key)
		where TSettings : class, ISettings
	...
	/// Get settings (copy)
	public static async Task<TSettings> CopyAsync<TSettings>(this IAsyncSettingsProvider provider)
		where TSettings : class, ISettings
		=> (TSettings)await provider.GetAsync(typeof(TSettings), SettingsKind.Copy);

	/// Get settings (copy)
	public static async Task<TSettings> CopyAsync<TSettings>(this IAsyncSettingsProvider provider, string key)
		where TSettings : class, ISettings
		=> (TSettings)await provider.GetAsync(typeof(TSettings), SettingsKind.Copy, key);

	/// Get settings (read)
	public static async Task<TSettings> ReadAsync<TSettings>(this IAsyncSettingsProvider provider)
		where TSettings : class, ISettings
		=> (TSettings)await provider.GetAsync(typeof(TSettings), SettingsKind.Read);

	/// Get settings (read)
	public static async Task<TSettings> ReadAsync<TSettings>(this IAsyncSettingsProvider provider, string key)
		where TSettings : class, ISettings
		=> (TSettings)await provider.GetAsync(typeof(TSettings), SettingsKind.Read, key);

	/// Get settings (inpc)
	public static async Task<TSettings> InpcAsync<TSettings>(this IAsyncSettingsProvider provider)
		where TSettings : class, ISettings
		=> (TSettings)await provider.GetAsync(typeof(TSettings), SettingsKind.Inpc);

	/// Get settings (inpc)
	public static async Task<TSettings> InpcAsync<TSettings>(this IAsyncSettingsProvider provider, string key)
		where TSettings : class, ISettings
		=> (TSettings)await provider.GetAsync(typeof(TSettings), SettingsKind.Inpc, key);

	/// Get settings (real)
	public static async Task<TSettings> RealAsync<TSettings>(this IAsyncSettingsProvider provider)
		where TSettings : class, ISettings
		=> (TSettings)await provider.GetAsync(typeof(TSettings), SettingsKind.Real);

	/// Get settings (real)
	public static async Task<TSettings> RealAsync<TSettings>(this IAsyncSettingsProvider provider, string key)
		where TSettings : class, ISettings
